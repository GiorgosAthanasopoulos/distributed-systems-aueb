...
public class CommandConfig {
    ...
    public static final String c_LIST_STORES_COMMAND_2 = "-ls";
    ...
    public static final String c_REPL_COMMAND_2 = "-r";
    public static final String c_SERVER_COMMAND = "--server";
    public static final String c_SERVER_COMMAND_2 = "-s";

    public static final String c_HELP_COMMAND = "--help";
    public static final String c_HELP_COMMAND_2 = "-h";
    ...
    public static final String c_QUIT_COMMAND_2 = "-q";
