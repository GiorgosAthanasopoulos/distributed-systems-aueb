...
public class Filters {
    // TODO: check if filters have value in json (gson gives them default, e.g. 0 to
    // ints, double -> if they are default ignore them

    // TODO: calculate distance between 2 locations

    // TODO: parse stars, price, and food type split by ,
