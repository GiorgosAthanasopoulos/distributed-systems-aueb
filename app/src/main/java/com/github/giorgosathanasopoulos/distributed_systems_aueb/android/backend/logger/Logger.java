package com.github.giorgosathanasopoulos.distributed_systems_aueb.android.backend.logger;
...
public class Logger {
    ...
    public static void log(Level p_Level, String p_Message) {
        String timestamp = LocalDateTime.now().format(LoggerConfig.c_DATE_FORMATTER);
